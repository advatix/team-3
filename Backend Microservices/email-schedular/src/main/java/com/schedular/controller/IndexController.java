...
public class IndexController {
	...
	@ResponseBody
	public ResponseEntity<?> healthCheck(TimeZone timezone, @RequestHeader Map<String, String> headers)
			throws JsonProcessingException, UnsupportedEncodingException {
		LogManager.info(getClass(), timezone, "WebService is up. Timezone: " + timezone.getID() + " "
				+ timezone.getDSTSavings() + " " + timezone.getDisplayName(Locale.US), MessageType.ApiRequestResponse);
